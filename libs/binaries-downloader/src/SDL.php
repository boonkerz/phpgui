...
final class SDL implements PluginInterface
{
    private const VENDOR  = 'libsdl-org';
    private const PACKAGE = 'SDL';
    private const VERSION = '2.28.2';
    ...
    private function package(): string
    {
        return match (\PHP_OS_FAMILY) {
            'Windows' => \PHP_INT_SIZE === 8 ? 'SDL2-' . self::VERSION . '-win32-x64.zip' : 'SDL2-' . self::VERSION . '-win32-x86.zip',
            'Linux', 'BSD' => 'SDL2-' . self::VERSION . '.tar.gz',
