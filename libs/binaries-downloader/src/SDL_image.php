...
final class SDL_image implements PluginInterface
{
    private const VENDOR  = 'libsdl-org';
    private const PACKAGE = 'SDL_image';
    private const VERSION = '2.6.3';
    ...
    private function package(): string
    {
        return match (\PHP_OS_FAMILY) {
            'Windows' => \PHP_INT_SIZE === 8 ? 'SDL2_image-' . self::VERSION . '-win32-x64.zip' : 'SDL2_image-' . self::VERSION . '-win32-x86.zip',
            'Linux', 'BSD' => 'SDL2_image-' . self::VERSION . '.tar.gz',
